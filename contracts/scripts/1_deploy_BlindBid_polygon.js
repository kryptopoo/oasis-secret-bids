...
async function main() {
  ...
  const remoteNetwork = hre.config.networks["polygon_mumbai"];
  ...
  const BlindBid = await BlindBidContract.deploy(predictAuctionAddress, ethers.utils.formatBytes32String("polygon"));
