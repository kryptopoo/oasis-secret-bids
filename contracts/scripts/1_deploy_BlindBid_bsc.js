...
async function main() {
  ...
  const remoteNetwork = hre.config.networks["bsc_testnet"];
  ...
  const BlindBid = await BlindBidContract.deploy(predictAuctionAddress, ethers.utils.formatBytes32String("bsc"));
